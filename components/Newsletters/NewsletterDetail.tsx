...
export default function NewsletterDetail({ id }: NewsletterDetailProps) {
  ...
  const renderHTMLContent = (htmlContent: string) => {
    ...
    let cleanContent = htmlContent
      ...
      .replace(/<h2>/g, '<h2 class="text-2xl font-bold text-orange-500 mb-4 border-b border-orange-500/30 pb-2">')
      .replace(/<h3>/g, '<h3 class="text-xl font-semibold text-white mb-3">')
      .replace(/<h4>/g, '<h4 class="text-lg font-medium text-orange-400 mb-2">')
      .replace(/<h5>/g, '<h5 class="text-base font-medium text-orange-300 mb-2">')

...
export default function HomeScreens({ currentScreen }: HomeScreensProps) {
  ...
  const timeline = [
    ...
    { 
      ...
      description: 'Radhika Bali and Associates joins hands with JCSS to form JCSS Law' 
    },
    { 
      year: '2023', 
                  ...
                  <div className="relative mt-4 pt-8 animate-fade-in-up animation-delay-200 mb-12 w-full max-w-7xl">
                    <div className="relative px-6 py-6 max-w-5xl mr-10">
                      ...
                      <div className="absolute top-1/2 transform translate-y-1/2 left-12 right-12 h-0.5" 
                           style={{
                             backgroundImage: 'repeating-linear-gradient(to right, #64748b 0px, #64748b 4px, transparent 4px, transparent 8px)',
                             height: '2px'
                           }}></div>
                      ...
                      <div className="flex justify-between items-center relative">
                        {timeline.map((item, index) => (
                          ...
                          >
                            ...
                            <span className={`text-base font-medium mb-3 transition-all duration-300 ${
                            ...
                            {/* Timeline point */}
                            <div className={`w-4 h-4 rounded-full border-white border-2 transition-all duration-300 relative ${
                              hoveredYear === item.year 
